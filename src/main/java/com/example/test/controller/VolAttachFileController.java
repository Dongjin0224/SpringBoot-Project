...
@Controller
@Slf4j
@RequestMapping("/volupload/*")
public class VolAttachFileController {

    @PostMapping(value = "uploadAjaxAction", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public List<VolAttachFileVO> uploadAjaxAction(MultipartFile[] uploadFiles){
...
//        년/월/일 폴더 생성
        ...
        for(MultipartFile multipartFile : uploadFiles){
            ...
            VolAttachFileVO volAttachFileVO = new VolAttachFileVO();
...
//            340간
            ...
            volAttachFileVO.setFileName(uploadFileName);
            ...
            try {
                ...
                volAttachFileVO.setUuid(uuid.toString());
                volAttachFileVO.setUploadPath(uploadFolderPath);

                if(checkImageType(saveFile)) {
                    volAttachFileVO.setImage(true);
